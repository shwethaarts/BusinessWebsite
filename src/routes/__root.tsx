  ...
  head: () => ({
    meta: [
      ...
      { title: "SHWETHA ARTS | Creative Branding Solutions in Bangalore" },
      {
        name: "description",
        content:
          "Glass frosting, business branding stickers, wall graphics, flex printing, name plates and vehicle branding in Bengaluru. Call 9900005087.",
      },
      { name: "author", content: "SHWETHA ARTS" },
      { property: "og:site_name", content: "SHWETHA ARTS" },
